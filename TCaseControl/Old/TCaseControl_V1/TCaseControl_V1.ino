 ...
 *********************************************************************
   ...
   TODO: add input from dash switch
*/
...
//Temporary vars, TODO this will go away when we implement the dash switch logic
...
void loop()
{
  ...
  if (currentState != requestedState && currentState != IMPOSSIBLE && requestedState != IMPOSSIBLE)
  {
  ...
  //else: either we are in the right state or there is an error somewhere and something is flagged as IMPOSSIBLE
  requestedState = getRequestedState();
